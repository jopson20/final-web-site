...
module.exports = {
    ...
    update : async (req,res,next) => {
        try {
            const re = await Articulo.update({ categoriaId: req.body.categoriaId, codigo: req.body.codigo, nombre: req.body.nombre, precio: req.body.precio, descripcion: req.body.descripcion}, {where : {id: req.body.id}})
            res.status(200).json(re)
        } 
